...
Getting started with Cognito Forms is easy. Just [sign up for a free account](https://www.cognitoforms.com/signup?utm_source=wordpress&utm_medium=referral&utm_campaign=profile), then choose "New Form" to create your first form. 
...
1. With Cognito Forms's easy-to-use form builder, create responsive contact forms, order forms, registration forms and more in minutes.
2. Add a block to the post or page where you'd like to embed your form.
3. Select the Cognito Forms block.
4. Choose "Select Form".
5. Select the form you would like to embed.
6. Your form is now embedded on the post/page.
